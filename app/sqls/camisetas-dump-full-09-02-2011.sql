...
-- Started on 2011-02-09 23:59:52
...
SELECT pg_catalog.setval('tb_favoritos_sq_favorito_seq', 6, true);
...
SELECT pg_catalog.setval('tb_pedidos_sq_pedido_seq', 27, true);
...
SELECT pg_catalog.setval('tb_produto_pedido_sq_produto_pedido_seq', 7, true);
...
SELECT pg_catalog.setval('tb_produtos_sq_produto_seq', 27, true);
...
SELECT pg_catalog.setval('tb_telefones_sq_telefone_seq', 6, true);
...
SELECT pg_catalog.setval('tb_usuarios_sq_usuario_seq', 9, true);
...
INSERT INTO tb_favoritos (sq_favorito, sq_usuario, sq_produto, st_ativo) VALUES (3, 1, 26, false);
...
INSERT INTO tb_telefones (sq_telefone, sq_usuario, tp_telefone, nu_telefone, nu_ddd, st_ativo) VALUES (4, 1, 'Residencial', '34346810', '061', true);
...
INSERT INTO tb_usuarios (sq_usuario, sq_perfil, sq_municipio, nm_usuario, nu_cpf, tx_senha, tx_email, tx_endereco, nu_cep, st_ativo) VALUES (1, 1, 5580, 'Michael Fernandes Rodrigues', '73762385149', 'V2tjNWFtUklTbkJpYlZVOQ==', 'cerberosnash@gmail.com', 'Quadra 205 Conjunto 12 Casa 06', '72610512', true);
...
-- Completed on 2011-02-09 23:59:54
