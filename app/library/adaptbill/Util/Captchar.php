...
if(!isset($_SESSION['CONFIG']['CAPTCHAR']['CODE_LENGTH']) ){
	$_SESSION['CONFIG']['CAPTCHAR']['CODE_LENGTH'] = 4;
}
/**
 ...
 *
 */
class Util_Captchar{ //Securimage {
   ...
   * @var string
   */
  var $ttf_file = "default/font/elephant.ttf";
   ...
   * @var string
   */
  var $multi_text_color = "#0a68dd,#f65c47,#8d32fd,#3333aa";
  ...
  function createCode()
  {
    ...
    $this->code_length = $_SESSION['CONFIG']['CAPTCHAR']['CODE_LENGTH'];
  ...
  function saveData()
  {
    $_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE'] = strtolower($this->code);
  }
  ...
  function validate()
  {
    if ( isset($_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE']) && !empty($_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE']) ) {
      if ( $_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE'] == strtolower(trim($this->code_entered)) ) {
        $this->correct_code = true;
        $_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE'] = '';
      } else {
  ...
  {
    if (isset($_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE']) && !empty($_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE'])) {
      return $_SESSION['CONFIG']['CAPTCHAR']['CODE_VALUE'];
    } else {
      return '';
    }
  }
