...
try{
    ...
    App.Default.Layout.Cliente = Ext.extend(Ext.util.Observable,{
        ...
        constructor: function(){
            ...
            var urlAutenticacao = '/camisetas/outros/png-1.0/login.php';
            var urlRecuperarSenha = '/camisetas/outros/png-1.0/recuperar_senha.php';
            ...
            var urlLogoff = '/camisetas/outros/png-1.0/logoff.php';
                            ...
                            if(responseObject.responseText){
                                try{
                                    ...
                                    if(data[0].success===true){
                                        ...
                                        RunnerAutenticacao.run(pbarAutenticacao, Ext.getCmp('aEntrar'), 19, function(){
                                            pbarAutenticacao.updateText('Concluído!');
                                        });
                                    
                                    }else{
                                        Ext.example.msg('Erro', 'Falha na autenticaçãoa');
                                        bbarAutenticacao.ate('Falha na autenticação');
                                    }
                                }catch(e){
                                    Ext.example.msg('Erro', '{0}',e);
                                }
