...
class Util_Securimage {
	 ...
	 * @var string
	 */
	var $background_directory = 'default/img/captchar_backgrounds'; 
	...
	*/
	...
	function Util_Securimage()
	{
		...
		$this->gd_font_file  = "default/font/automatic.gdf";
		$this->use_gd_font   = false;
		$this->gd_font_size  = 24;
		$this->text_x_start  = 15;

		$this->ttf_file      = 'default/font/AHGBold.ttf';
		...
		$this->signature_font  = 'default/font/AHGBold.ttf';

		$this->audio_path   = './default/audio/';//'./audio/';
