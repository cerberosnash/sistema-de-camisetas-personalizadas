...
<html>
    <head>
        <title><?php echo $_SESSION["dadosboleto"]["identificacao"]; ?></title>
    ...
    <BODY>
        ...
        <body>
            ...
            <div id="container">
                ...
                <div id="instr_header">
                    <h1><?php echo $_SESSION["dadosboleto"]["identificacao"]; ?> <?php echo isset($_SESSION["dadosboleto"]["cpf_cnpj"]) ? $_SESSION["dadosboleto"]["cpf_cnpj"] : '' ?></h1>
                    <address><?php echo $_SESSION["dadosboleto"]["endereco"]; ?><br></address>
                    <address><?php echo $_SESSION["dadosboleto"]["cidade_uf"]; ?></address>
                </div>	<!-- id="instr_header" -->
                ...
                <div id="">
                    ...
                    <div id="instr_content">
                        <p>
				O pagamento deste boleto tambem podera ser efetuado
				...
				qualidade normal ou alta. Nao use modo econ&ocirc;mico.
				...
				formulario.
                            ...
                            <li>
				Corte na linha indicada. Nao rasure, risque, fure ou dobre
				a regiao onde se encontra o c&oacute;digo de barras
                            </li>
                        </ol>
                    </div>	<!-- id="instr_content" -->
                </div>	<!-- id="instructions" -->
                <div id="boleto">
                    ...
                    <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD class=ct width=666><div align=right><b class=cp>Recibo do Sacado</b></div></TD></tr></tbody></table>
                    <table class="header" border=0 cellspacing="0" cellpadding="0">
                        <tbody>
                            <tr>
                                <td width=150><IMG SRC="<?php echo BOLETO_PATH; ?>imagens/logobb.jpg"></td>
                                <td width=50>
                                    <div class="field_cod_banco"><?php echo $_SESSION["dadosboleto"]["codigo_banco_com_dv"] ?></div>
                                </td>
                                <td class="linha_digitavel"><?php echo $_SESSION["dadosboleto"]["linha_digitavel"] ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="line" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                <td class="cedente"><?php echo $_SESSION["dadosboleto"]["cedente"]; ?>&nbsp;</td>
                                <td class="ag_cod_cedente"><?php echo $_SESSION["dadosboleto"]["agencia_codigo"] ?> &nbsp;</td>
                                <td class="especie"><?php echo $_SESSION["dadosboleto"]["especie"] ?>&nbsp;</td>
                                <TD class="qtd"><?php echo $_SESSION["dadosboleto"]["quantidade"] ?>&nbsp;</td>
                                <TD class="nosso_numero"><?php echo $_SESSION["dadosboleto"]["nosso_numero"] ?>&nbsp;</td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="line" cellspacing="0" cellPadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                <td class="num_doc"><?php echo $_SESSION["dadosboleto"]["numero_documento"] ?></td>
                                <td class="contrato"><?php echo $_SESSION["dadosboleto"]["contrato"] ?></td>
                                <td class="cpf_cei_cnpj"><?php echo $_SESSION["dadosboleto"]["cpf_cnpj"] ?></td>
                                <td class="vencimento"><?php echo $_SESSION["dadosboleto"]["data_vencimento"] ?></td>
                                <td class="valor_doc"><?php echo $_SESSION["dadosboleto"]["valor_boleto"] ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="line" cellspacing="0" cellPadding="0">
                        <tbody>
                            <tr class="titulos">
                                ...
                                <td class="outros_acrescimos">(+) Outros acrescimos</td>
                    ...
                    <table class="line" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                <td class="sacado"><?php echo $_SESSION["dadosboleto"]["sacado"] ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="footer">
                        <p>Autentica&ccedil;ao mec&acirc;nica</p>
                    </div>
                    <div class="cut">
                        <p>Corte na linha pontilhada</p>
                    </div>
                    ...
                    <table class="line" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                <td class="local_pagto">QUALQUER BANCO ATe O VENCIMENTO</td>
                                <td class="vencimento2"><?php echo $_SESSION["dadosboleto"]["data_vencimento"] ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="line" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                <td class="cedente2"><?php echo $_SESSION["dadosboleto"]["cedente"] ?></td>
                                <td class="ag_cod_cedente2"><?php echo $_SESSION["dadosboleto"]["agencia_codigo"] ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="line" cellspacing="0" cellpadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                <td class="data_doc"><?php echo $_SESSION["dadosboleto"]["data_documento"] ?></td>
                                <td class="num_doc2"><?php echo $_SESSION["dadosboleto"]["numero_documento"] ?></td>
                                <td class="especie_doc"><?php echo $_SESSION["dadosboleto"]["especie_doc"] ?></td>
                                <td class="aceite"><?php echo $_SESSION["dadosboleto"]["aceite"] ?></td>
                                <td class="data_process"><?php echo $_SESSION["dadosboleto"]["data_processamento"] ?></td>
                                <td class="nosso_numero2"><?php echo $_SESSION["dadosboleto"]["nosso_numero"] ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="line" cellspacing="0" cellPadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                ...
                                <td class="carteira"><?php echo $_SESSION["dadosboleto"]["carteira"] ?> <?php echo isset($_SESSION["dadosboleto"]["variacao_carteira"]) ? $_SESSION["dadosboleto"]["variacao_carteira"] : '&nbsp;' ?></td>
                                <td class="especie2"><?php echo $_SESSION["dadosboleto"]["especie"] ?></td>
                                <td class="qtd2"><?php echo $_SESSION["dadosboleto"]["quantidade"] ?></td>
                                <td class="xvalor"><?php echo $_SESSION["dadosboleto"]["valor_unitario"] ?></td>
                                <td class="valor_doc2"><?php echo $_SESSION["dadosboleto"]["valor_boleto"] ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <table class="line" cellspacing="0" cellpadding="0">
						...
						Instru&ccedil;&otilde;es (Texto de responsabilidade do cedente)
                                            ...
                                            <tr class="campos">
                                                <td class="instrucoes" rowspan="5">
                                                    <p><?php echo $_SESSION["dadosboleto"]["demonstrativo1"]; ?></p>
                                                    <p><?php echo $_SESSION["dadosboleto"]["demonstrativo2"]; ?></p>
                                                    <p><?php echo $_SESSION["dadosboleto"]["demonstrativo3"]; ?></p>
                                                    <p><?php echo $_SESSION["dadosboleto"]["instrucoes1"]; ?></p>
                                                    <p><?php echo $_SESSION["dadosboleto"]["instrucoes2"]; ?></p>
                                                    <p><?php echo $_SESSION["dadosboleto"]["instrucoes3"]; ?></p>
                                                    <p><?php echo $_SESSION["dadosboleto"]["instrucoes4"]; ?></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr><td>
                                    <table class="line" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr class="titulos">
                                                <td class="outros_acrescimos2">(+) Outros Acrescimos</td>
                                            </tr>
                                            <tr class="campos">
                    ...
                    <table class="line" cellspacing="0" cellPadding="0">
                        <tbody>
                            ...
                            <tr class="campos">
                                <td class="sacado2">
                                    <p><?php echo $_SESSION["dadosboleto"]["sacado"] ?></p>
                                    <p><?php echo $_SESSION["dadosboleto"]["endereco1"] ?></p>
                                    <p><?php echo $_SESSION["dadosboleto"]["endereco2"] ?></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table cellspacing=0 cellpadding=0 width=666 border=0><TBODY><TR><TD width=666 align=right ><font style="font-size: 10px;">Autentica&ccedil;ao mec&acirc;nica - Ficha de Compensa��o</font></TD></tr></tbody></table>
                    <div class="barcode">
                        <p><?php BoletoBB::fbarcode($_SESSION["dadosboleto"]["codigo_barras"]); ?></p>
                    </div>
                    <div class="cut">
                        <p>Corte na linha pontilhada</p>
                    </div>
